...
export default async function Projects() {
  ...
  return (
    <div className="min-h-screen flex flex-col p-4">
      <h1 className="text-4xl font-bold text-amber-400 underline">Projects</h1>
      <div className="mt-6 flex flex-row flex-wrap gap-4">
        {projects.map((project) => (
        <Link href={`/projects/${project._id}`} key={project._id.toString()} className="group relative p-4 flex flex-col justify-center gap-4 w-[100%] md:w-[20rem] h-[15rem] border-3 border-neutral-700 rounded-xl shadow-lg shadow-neutral-900 hover:bg-amber-300 transtion duration-300 ease-in hover:text-black hover:border-white overflow-hidden" >
          <div className="mb-4">
