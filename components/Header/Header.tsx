    ...
    return (
        <header>
            <div className="flex flex-row items-center bg-neutral-900 ">
                ...
                <Link href="/projects" className={`sm:text-xl md:text-2xl p-3  hover:text-black transition duration-300 ease-in ${pathName === "/projects" ? "bg-amber-300 text-black" : "hover:bg-amber-500"}`}>Projects</Link>
